...
//  $.ajax({
//    url: contextPath +"/product", // 控制器的请求 URL
//    method: "GET",
//    dataType: "json", // 响应数据的类型，这里假设返回 JSON 格式数据
//    success: function(response) {
//      var productList = response.list.content; // 获取菜品列表数据s
//
//      // 清空表格内容
...
//          "</tr>";
//
//        $("#productTable").append(row); // 添加新行到表格
//      });
//    },
