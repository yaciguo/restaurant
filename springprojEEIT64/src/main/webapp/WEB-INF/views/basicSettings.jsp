	...
	<div id="main-content" class="main-content">
		<ul class="nav nav-tabs" id="activity-tabs">
			<li class="nav-item"><a class="activity-link nav-link active"
					data-bs-toggle="tab" href="#basic-setting-div">廣告看板</a></li>
			<li class="nav-item"><a class="activity-link nav-link"
					data-bs-toggle="tab" href="#seat-setting-div">活動設定</a></li>
			<li class="nav-item"><a class="activity-link nav-link"
					data-bs-toggle="tab" href="#opening-setting-div">活動設定</a></li>
		</ul>

		<!-- 分頁內容-->
		<div class="tab-content">
			<div id="basic-setting-div"
					...
					<div class="col-6 text-nowrap">
						...
						<div class="row px-2">
							<div class="panel-body panel scheduler-border pb-2">
								...
								<div class="col mb-2"
									style="height: 200px; background-color: aqua;"></div>
								<div class="col offset-10 col-2 d-flex">
									<button type="button" class="btn btn-primary flex-fill">上傳商標</button>
						...
						<div class="row ps-2 pe-3">
							<div class="panel-body panel scheduler-border pb-2">
								...
								<div class="panel-body panel scheduler-border pb-2 px-2">
									...
									<div class="row mb-1">
										<div class="btn-group col-3 text-nowrap mt-3 mb-2"
											role="group" aria-label="Basic radio toggle button group">
											<input type="radio" class="btn-check" name="btnradio-style"
												id="btnradio-style1" autocomplete="off" checked>
											<label class="btn btn-outline-primary" for="btnradio-style1">按鈕樣式</label>
											<input type="radio" class="btn-check" name="btnradio-style"
												id="btnradio-style2" autocomplete="off">
											<label class="btn btn-outline-primary" for="btnradio-style2">按鈕樣式</label>
											<input type="radio" class="btn-check" name="btnradio-style"
												id="btnradio-style3" autocomplete="off">
											<label class="btn btn-outline-primary" for="btnradio-style3">按鈕樣式</label>
										</div>
									</div>
									<div class="row px-3 col-9">
										<table class="table table-hover table-primary data">
								...
								<div class="row mb-4 g-4 p-4">
									<div class="col col-3 d-flex">
										<button type="button"
											...
											<div class="flex-fill h-100 seat-btn">
												<span class="seat-num">桌號：<span>1</span></span> <span
													class="seat-people ">座位人數：<span>4</span></span>
											</div>
										</button>
									</div>
									<div class="col col-3 d-flex">
									...
									<div class="col col-3 d-flex">
										<button type="button"
											class="style-set btn btn-primary flex-fill p-0">
											<div class="flex-fill "
												style="font-size: 80px; vertical-align: middle;">+</div>
										</button>
									</div>
								</div>
							</div>
										...
										<div class="me-2">
											<table class="table table-hover table-primary data">
												...
												<tbody class="faq-body data">
													<tr class="data">
														<td class="checkbox-td data "><input
																class="form-check-input " type="checkbox"
																value="option1" id="AAA"></td>
														<td class="data">星期一</td>
														<td class="data">8:00</td>
														<td class="data">13:00</td>
														<td class="td-btn p-1">
								...
								<div class="row me-1">
									<div class="col-2 d-flex ps-2 pe-1">
										<a class="btn btn-primary btn-sm flex-fill" id="allCheck"
											type="button">全選</a>
										<a class="btn btn-primary btn-sm flex-fill"
											id="removeAllCheck" type="button" style="display: none;">清空</a>
									</div>
									<div class="offset-5 col-3 d-flex px-1">
									...
									<div class="col-2 d-flex px-1">
										<a class="btn btn-primary btn-sm flex-fill" type="button"
											data-bs-toggle="modal" data-bs-target="#tdItemModalDiv">新增</a>
									</div>
								</div>
							</div>
						</div>
									...
									<div class="accordion-item ">
										<h2 class="accordion-header " id="flush-headingOne">
											<button class="accordion-button collapsed" type="button"
												...
												aria-controls="flush-collapseOne">休假</button>
										</h2>
									...
									<div class="accordion-item">
										<h2 class="accordion-header" id="flush-headingTwo">
											<button class="accordion-button collapsed" type="button"
												...
												aria-controls="flush-collapseTwo">過去休假</button>
										</h2>
		...
		<div id="tdItemModalDiv" class="modal fade" tabindex="-1"
			role="dialog">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content px-3">
					<div class="modal-header pb-1">
					...
					<div class="modal-body pt-3 pb-0">
						<div class="row">
							...
							<div class="col-5">
								<input class="form-control" id="setdate" name="setdate"
						...
						<div class="row">
							<div class="col-3 d-flex align-items-center"">
								<label class=" justify-content-center align-items-center">時間：</label>
							</div>
							<div class="col-5">
								<input type="time" class="form-control" step="3600" required>
								<input type="time" class="form-control" step="3600" required>
							</div>
						</div>
						<div class="row">
					...
					<div class="modal-footer px-0">
						<div class="row flex-fill">
							<button type="button" class="col col-md-3 btn btn-primary">清空</button>
							<button type="button"
								class="col col-md-3 btn btn-primary offset-sm-6">確定</button>
						</div>
					</div>
				</div>
			</div>
