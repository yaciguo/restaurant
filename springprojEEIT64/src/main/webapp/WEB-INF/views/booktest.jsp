							...
							<%@ include file="nav.jsp" %>
								...
								<div class="title-intro">
									...
									<div class="row">
										<div>
											餐廳地址: 台中市南屯區公益路二段42號
											<a href="<c:url value='https://goo.gl/maps/tYQZqHMS9LfWwVoE9' />"
												target="_blank"><img src="<c:url value='/images/mapicon.png' />" alt=""
													style="width: 30px" /></a>
										</div>
								...
								<br />
								<div>
									<form:form id="myForm" onsubmit="return validateAndRedirect()"
										...
										<div class="fieldset-container">
											<fieldset class="fieldsetdata">
												...
												<% Date today=new Date(); Date tomorrow=new Date();
													tomorrow.setTime(today.getTime() + (24 * 60 * 60 * 1000)); // 加一天
													Date sevenDaysLater=new Date();
													sevenDaysLater.setTime(today.getTime() + (7 * 24 * 60 * 60 * 1000));
													// 加七天 SimpleDateFormat dateFormat=new
													SimpleDateFormat("yyyy-MM-dd"); %>

													<label for="date">日期:</label>
													<form:input path="date" id="date" type="date" required="true"
														pattern="yyyy-MM-dd" min="<%= dateFormat.format(tomorrow) %>"
														max="<%= dateFormat.format(sevenDaysLater) %>"
													...
													<form:input path="name" id="name" type="text" placeholder="請輸入訂位人"
														required="true" />
													<form:radiobutton path="gender" name="gender" value="M"
														required="true" label="先生" />
													<form:radiobutton path="gender" name="gender" value="F"
														required="true" label="小姐" />
										...
										<div>
											<fieldset class="fieldsetdata">
												<legend>備註</legend>
												<form:textarea path="note" id="note" cols="30" rows="10"
													style="width: 99%" placeholder="請輸入訂位備註"></form:textarea>
